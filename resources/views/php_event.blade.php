        ...
        <div class="pt-4 pr-4 pl-4 pb-4">
            <form action="{{ route('php.search') }}" method="get">
                ...
                <div class="text-center mx-auto mt-2 d-flex justify-content-center">
                    <button type="submit" class="btn site-btn text-white pr-5 pl-5 mb-5">検索</button>
    ...
    <div class="mt-2 col-md-7 p-0 mb-4">
        ...
        <div class="mt-1">
            ...
            <ul class="list-unstyled event-card pb-4 pt-4 pl-4 pr-4">
                ...
                <li class="list-unstyled mr-3 pt-2 text-dark card-item"><i class="far fa-clock text-dark mr-2"></i>{{ Str::substr($list->date, 0, 4) }}年{{ Str::substr($list->date, 5, 2) }}月{{ Str::substr($list->date, 8, 2) }}日 {{ $list->begin_time }}〜{{ $list->end_time }}</li>
                <li class="list-unstyled pt-1 text-dark card-item"><i class="fas fa-map-marker-alt text-dark mr-2"></i>{{$list->address }}</li>
                <li class="pt-1 list-unstyled text-dark card-item"><i class="fas fa-users mr-1 text-dark"></i>{{ $list->group }}</li>
