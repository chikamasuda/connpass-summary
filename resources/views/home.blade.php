...
<section class="row container justify-content-center mx-auto pb-3">
    <div class="col-md-7 p-0 mt-4">
        ...
        <div class="pb-2 card-header font-weight-bold alert-header mt-4">
            <h2 class="card-title font-weight-bold pb-1 pt-1 text-white"><i class="fas fa-exclamation-triangle mr-1"></i>
                人気急上昇イベント(直近24時間）
            </h2>
        </div>
        @foreach($lists as $list)
        <ul class="list-unstyled event-card pb-4 pt-4 pl-4 pr-4 mt-3">
